		...
		<div class="col-3">
			<ul style="list-style-type: none">
				<li><img src="https://i.ibb.co/LPC9K97/Logo-1000x1000-px.png"
					...
					<h6 style="font-family: 'Lato', sans-serif;" class="">DAILY
						NEWS PAPER AGENCY</h6> <br>
				<li><img
					src="https://img.icons8.com/ios-glyphs/30/000000/marker--v1.png" />
					HQ :- L3, Murlidhar Complex, Near Nehru Nagar, SM Road, Ambawadi,
					India.
			</ul>
		</div>
		<div class="col-3"></div>
