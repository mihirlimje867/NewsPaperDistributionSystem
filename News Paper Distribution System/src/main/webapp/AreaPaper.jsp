					...
					<div class="col-lg-4">
						...
						<form action="" method="post">
							...
							<div class="form-outline">
								...
								Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/college", "root", "Mihir@123");
						...
						<table class="table table-bordered text-center table-hover">
							...
							<tbody>
								...
								if (request.getParameter("Search1") != null) {
									...
									Class.forName("com.mysql.cj.jdbc.Driver");
									con = DriverManager.getConnection("jdbc:mysql://localhost:3306/college", "root", "Mihir@123");
